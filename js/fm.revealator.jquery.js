...
$(function () {
	...
	Revealator.refresh = function () {
		...
		$('*[class*="revealator"]').each(function () {
			...
			if (element_bounding.top > window_bottom && element_bounding.bottom > window_bottom + 190) {
				position_class = 'revealator-below';
			} else if (element_bounding.top < window_bottom && element_bounding.bottom > window_bottom + 190) {
				position_class = 'revealator-partially-below'
			} else if (element_bounding.top < window_top && element_bounding.bottom > window_top + 190) {
